...
public class UserEdit extends JDialog {
	...
	public UserEdit(JFrame f) {
		super(f, "Изменение", Dialog.ModalityType.DOCUMENT_MODAL);
	...
	public void loadUser() {
		f_username.setText(((User) this.getOwner()).get_username());
		f_ename.setText(((User) this.getOwner()).get_ename());
	}

	private void saveUser() {
		((User) this.getOwner()).edit(f_username.getText(), f_ename.getText());
		f_username.setText("");
		f_ename.setText("");
	}
}
