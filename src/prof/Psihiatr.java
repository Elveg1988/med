...
public class Psihiatr extends JDialog {
	...
	public Psihiatr(Osmotr osmotr) {
		super(osmotr, "Психиатр", Dialog.ModalityType.DOCUMENT_MODAL);
		...
		f_mkb.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent arg0) {
				if (!arg0.getItem().equals("Z")) {
					osmotr.b_17.setBackground(Color.RED);
				} else {
					osmotr.b_17.setBackground(Color.GREEN);
				}
			}
